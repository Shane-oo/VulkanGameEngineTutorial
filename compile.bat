E:\Programs\VulkanSDK\1.3.280.0\Bin\glslc.exe -fshader-stage=vertex VulkanGameEngine\shaders\simple_shader_vert.glsl -o  VulkanGameEngine\shaders\simple_shader_vert.glsl.spv
