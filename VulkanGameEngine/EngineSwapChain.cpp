...
EngineSwapChain::EngineSwapChain(
    EngineDevice &deviceRef, VkExtent2D windowExtent,
...
VkResult EngineSwapChain::submitCommandBuffers(const VkCommandBuffer *buffers,
                                               uint32_t *imageIndex) {
...
VkExtent2D EngineSwapChain::chooseSwapExtent(
