...
void EngineDevice::pickPhysicalDevice() {
    ...
    printf("physical engineDevice: %s\n", properties.deviceName);
}
...
void EngineDevice::createLogicalDevice() {
    ...
    // might not really be necessary anymore because engineDevice specific validation layers
    ...
    if (vkCreateDevice(physicalDevice, &createInfo, nullptr, &device_) != VK_SUCCESS) {
        throw std::runtime_error("failed to create logical engineDevice!");
    }
